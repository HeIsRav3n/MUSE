...
export const mockArtistCoins: ArtistCoin[] = [
...
export const mockAlbumBonds: AlbumBond[] = [
...
export const mockWalletActivity: WalletActivityItem[] = [
    { id: '1', type: 'buy', address: '0x7a3d...f82e', amount: 5000, token: '$VEX', timestamp: '2 min ago', usdValue: 11_700 },
    { id: '2', type: 'stake', address: '0x4b1c...a93d', amount: 10000, token: '$SOUND', timestamp: '5 min ago', usdValue: 45_000 },
    ...
    { id: '5', type: 'claim', address: '0x5f3b...d82c', amount: 750, token: '$SOUND', timestamp: '15 min ago', usdValue: 3_375 },
...
export const mockScouts: ScoutEntry[] = [
...
export const mockBreakoutPredictions: BreakoutPrediction[] = [
...
export const mockStemListings: StemListing[] = [
...
export const mockPortfolioHoldings: PortfolioHolding[] = [
    ...
    { id: '4', name: '$SOUND', type: 'Coin', amount: 25_000, value: 112_500, costBasis: 75_000, change24h: 4.2, image: '' },
